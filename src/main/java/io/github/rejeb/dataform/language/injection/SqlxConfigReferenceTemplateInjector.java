...
public class SqlxConfigReferenceTemplateInjector implements MultiHostInjector {
    ...
    public void getLanguagesToInject(@NotNull MultiHostRegistrar registrar,
        ...
        if (endOffset > startOffset) {
            ...
            registrar.startInjecting(SqlxLanguage.INSTANCE);
    ...
    public List<? extends Class<? extends PsiElement>> elementsToInjectIn() {
        return List.of(SqlxConfigRefExpression.class);
    }
}
