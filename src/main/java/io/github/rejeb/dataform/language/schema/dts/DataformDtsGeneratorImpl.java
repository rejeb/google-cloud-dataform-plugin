...
public class DataformDtsGeneratorImpl implements DataformDtsGenerator {
    ...
    public void generateDts() {
        ...
        // $defs → interfaces TS auxiliaires
        ...
        // oneOf → une interface par sqlx type
        ...
        if (oneOf != null) {
            for (JsonNode branch : oneOf) {
                ...
                // Read type value from properties.type.enum[0]
    ...
    // fieldToTs et scalarToTs reçoivent maintenant les index en paramètre
