...
public abstract class SqlxOperationsBlock extends ASTWrapperPsiElement
        implements PsiLanguageInjectionHost {

    public SqlxOperationsBlock(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    public SqlxOperationsBlock updateText(@NotNull String text) {
