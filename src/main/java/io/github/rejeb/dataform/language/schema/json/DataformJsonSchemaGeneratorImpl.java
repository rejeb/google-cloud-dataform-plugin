...
public final class DataformJsonSchemaGeneratorImpl implements DataformJsonSchemaGenerator {

    private static final Logger LOGGER = Logger.getInstance(DataformJsonSchemaGeneratorImpl.class.getName());
    ...
    private ObjectNode buildWorkflowSettingsSchema() {
