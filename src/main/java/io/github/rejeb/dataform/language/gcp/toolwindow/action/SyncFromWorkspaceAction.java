...
public class SyncFromWorkspaceAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        callback.onSync(workspaceIdSupplier.get());
    }
}
