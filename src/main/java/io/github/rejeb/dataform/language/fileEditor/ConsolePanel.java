...
public class ConsolePanel extends JPanel {
    ...
    public ConsolePanel() {
        ...
        contentArea.setBorder(JBUI.Borders.empty(10));

        JLabel hint = new JLabel("Aucun résultat pour le moment");
        hint.setForeground(UIUtil.getContextHelpForeground());
        hint.setFont(JBUI.Fonts.label(12));
        contentArea.add(hint, BorderLayout.NORTH);
