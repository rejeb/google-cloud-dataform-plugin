...
public class SqlxValidationServiceImplTest extends BasePlatformTestCase {

    public void testServiceIsRegisteredAndResolvable() {
        assertNotNull(SqlxValidationService.getInstance(getProject()));
    }

    public void testCleanFileYieldsNoProblems() {
